...
Shader "Raygeas/URP/Surface"
{
	...
	SubShader
	{
		...
		Pass
		{
			...
			sampler2D _MainTex;
			sampler2D _CovMainTex;
			sampler2D _BumpMap;
			sampler2D _CovMask;
			sampler2D _CovBumpMap;
			sampler2D _MetallicGlossMap;
			sampler2D _CoverageMetallicSmoothness;
						 ...
						 ) : SV_Target
			{
				...
				float2 texCoord472 = IN.ase_texcoord8.xy * temp_cast_0 + float2( 0,0 );
				...
				float4 triplanar421 = TriplanarSampling421( _CovMainTex, WorldPosition, WorldNormal, 10.0, temp_cast_1, 1.0, 0 );
				float3 unpack6 = UnpackNormalScale( tex2D( _BumpMap, Tiling462 ), _BumpScale );
				...
				float lerpResult457 = lerp( worldNormal283.y , IN.ase_texcoord9.xyz.y , _CovOverlayMethod);
				...
				float2 texCoord545 = IN.ase_texcoord8.xy * appendResult550 + float2( 0,0 );
				...
				float3 triplanar432 = TriplanarSampling432( _CovBumpMap, WorldPosition, WorldNormal, 10.0, temp_cast_4, _CovBumpScale, 0 );
				...
				float4 triplanar430 = TriplanarSampling430( _CoverageMetallicSmoothness, WorldPosition, WorldNormal, 10.0, temp_cast_5, 1.0, 0 );
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float2 temp_cast_0 = (_Tiling).xx;
				float2 texCoord472 = IN.ase_texcoord4.xy * temp_cast_0 + float2( 0,0 );
				float2 Tiling462 = texCoord472;
				float4 tex2DNode2 = tex2D( _MainTex, Tiling462 );
				float4 temp_output_3_0 = ( _Color * tex2DNode2 );
				float CoverageTiling463 = _CovTiling;
				...
				float4 triplanar421 = TriplanarSampling421( _CovMainTex, WorldPosition, ase_worldNormal, 10.0, temp_cast_1, 1.0, 0 );
				float3 unpack6 = UnpackNormalScale( tex2D( _BumpMap, Tiling462 ), _BumpScale );
				unpack6.z = lerp( 1, unpack6.z, saturate(_BumpScale) );
				float3 tex2DNode6 = unpack6;
				float3 MainNormalMap454 = tex2DNode6;
				...
				float3 tanNormal283 = MainNormalMap454;
				float3 worldNormal283 = float3(dot(tanToWorld0,tanNormal283), dot(tanToWorld1,tanNormal283), dot(tanToWorld2,tanNormal283));
				float lerpResult457 = lerp( worldNormal283.y , IN.ase_texcoord8.xyz.y , _CovOverlayMethod);
				float temp_output_289_0 = ( lerpResult457 + ( 1.0 - _CovOffset ) );
				float lerpResult541 = lerp( temp_output_289_0 , ( 1.0 - temp_output_289_0 ) , _CovBalance);
				float2 appendResult550 = (float2(_MaskTilingX , _MaskTilingY));
				float2 texCoord545 = IN.ase_texcoord4.xy * appendResult550 + float2( 0,0 );
				float2 MaskTiling551 = texCoord545;
				float4 tex2DNode507 = tex2D( _CovMask, MaskTiling551 );
				float lerpResult524 = lerp( ( 1.0 - tex2DNode507.g ) , tex2DNode507.g , _MaskContrast);
				float CoverageMask297 = saturate( ( lerpResult541 * saturate( lerpResult524 ) ) );
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float2 temp_cast_0 = (_Tiling).xx;
				float2 texCoord472 = IN.ase_texcoord2.xy * temp_cast_0 + float2( 0,0 );
				float2 Tiling462 = texCoord472;
				float4 tex2DNode2 = tex2D( _MainTex, Tiling462 );
				float4 temp_output_3_0 = ( _Color * tex2DNode2 );
				float CoverageTiling463 = _CovTiling;
				...
				float3 tanNormal283 = MainNormalMap454;
				float3 worldNormal283 = float3(dot(tanToWorld0,tanNormal283), dot(tanToWorld1,tanNormal283), dot(tanToWorld2,tanNormal283));
				float lerpResult457 = lerp( worldNormal283.y , IN.ase_texcoord6.xyz.y , _CovOverlayMethod);
				float temp_output_289_0 = ( lerpResult457 + ( 1.0 - _CovOffset ) );
				float lerpResult541 = lerp( temp_output_289_0 , ( 1.0 - temp_output_289_0 ) , _CovBalance);
				float2 appendResult550 = (float2(_MaskTilingX , _MaskTilingY));
				float2 texCoord545 = IN.ase_texcoord2.xy * appendResult550 + float2( 0,0 );
				float2 MaskTiling551 = texCoord545;
				float4 tex2DNode507 = tex2D( _CovMask, MaskTiling551 );
				float lerpResult524 = lerp( ( 1.0 - tex2DNode507.g ) , tex2DNode507.g , _MaskContrast);
				float CoverageMask297 = saturate( ( lerpResult541 * saturate( lerpResult524 ) ) );
		...
		Pass
		{
						 ...
						 ) : SV_TARGET
			{
				...
				float2 temp_cast_0 = (_Tiling).xx;
				float2 texCoord472 = IN.ase_texcoord5.xy * temp_cast_0 + float2( 0,0 );
				float2 Tiling462 = texCoord472;
				float3 unpack6 = UnpackNormalScale( tex2D( _BumpMap, Tiling462 ), _BumpScale );
				unpack6.z = lerp( 1, unpack6.z, saturate(_BumpScale) );
				float3 tex2DNode6 = unpack6;
				...
				float3 triplanar432 = TriplanarSampling432( _CovBumpMap, WorldPosition, WorldNormal, 10.0, temp_cast_1, _CovBumpScale, 0 );
				float3 tanTriplanarNormal432 = mul( ase_worldToTangent, triplanar432 );
				float3 lerpResult515 = lerp( BlendNormal( tex2DNode6 , tanTriplanarNormal432 ) , tanTriplanarNormal432 , ( 1.0 - _NormalBlending ));
				float3 MainNormalMap454 = tex2DNode6;
				...
				float3 tanNormal283 = MainNormalMap454;
				float3 worldNormal283 = float3(dot(tanToWorld0,tanNormal283), dot(tanToWorld1,tanNormal283), dot(tanToWorld2,tanNormal283));
				float lerpResult457 = lerp( worldNormal283.y , IN.ase_texcoord7.xyz.y , _CovOverlayMethod);
				float temp_output_289_0 = ( lerpResult457 + ( 1.0 - _CovOffset ) );
				float lerpResult541 = lerp( temp_output_289_0 , ( 1.0 - temp_output_289_0 ) , _CovBalance);
				float2 appendResult550 = (float2(_MaskTilingX , _MaskTilingY));
				float2 texCoord545 = IN.ase_texcoord5.xy * appendResult550 + float2( 0,0 );
				float2 MaskTiling551 = texCoord545;
				float4 tex2DNode507 = tex2D( _CovMask, MaskTiling551 );
				float lerpResult524 = lerp( ( 1.0 - tex2DNode507.g ) , tex2DNode507.g , _MaskContrast);
				float CoverageMask297 = saturate( ( lerpResult541 * saturate( lerpResult524 ) ) );
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;553;-342.2618,-860.8546;Float;False;False;-1;2;UnityEditor.ShaderGraphLitGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;ExtraPrePass;0;0;ExtraPrePass;5;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Lit;True;3;True;12;all;0;False;True;1;1;False;;0;False;;0;1;False;;0;False;;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;True;True;True;True;0;False;;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;0;False;False;0;;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;554;-342.2618,-860.8546;Float;False;True;-1;2;UnityEditor.ShaderGraphLitGUI;0;12;Raygeas/URP/Surface;94348b07e5e8bab40bd6c8a1e3df54cd;True;Forward;0;1;Forward;21;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Lit;True;3;True;12;all;0;False;True;1;1;False;;0;False;;1;1;False;;0;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;1;LightMode=UniversalForward;False;False;0;;0;0;Standard;42;Lighting Model;0;0;Workflow;1;0;Surface;0;0;  Refraction Model;0;0;  Blend;0;0;Two Sided;1;0;Fragment Normal Space,InvertActionOnDeselection;0;0;Forward Only;0;0;Transmission;0;0;  Transmission Shadow;0.5,False,;0;Translucency;0;0;  Translucency Strength;1,False,;0;  Normal Distortion;0.5,False,;0;  Scattering;2,False,;0;  Direct;0.9,False,;0;  Ambient;0.1,False,;0;  Shadow;0.5,False,;0;Cast Shadows;1;0;  Use Shadow Threshold;0;0;Receive Shadows;1;0;Receive SSAO;1;0;GPU Instancing;1;0;LOD CrossFade;1;0;Built-in Fog;1;0;_FinalColorxAlpha;0;0;Meta Pass;1;0;Override Baked GI;0;0;Extra Pre Pass;0;0;Tessellation;0;0;  Phong;0;0;  Strength;0.5,False,;0;  Type;0;0;  Tess;16,False,;0;  Min;10,False,;0;  Max;25,False,;0;  Edge Length;16,False,;0;  Max Displacement;25,False,;0;Write Depth;0;0;  Early Z;0;0;Vertex Position,InvertActionOnDeselection;1;0;Debug Display;0;0;Clear Coat;0;0;0;10;False;True;True;True;True;True;True;True;True;True;False;;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;555;-342.2618,-860.8546;Float;False;False;-1;2;UnityEditor.ShaderGraphLitGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;ShadowCaster;0;2;ShadowCaster;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Lit;True;3;True;12;all;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;False;False;True;False;False;False;False;0;False;;False;False;False;False;False;False;False;False;False;True;1;False;;True;3;False;;False;True;1;LightMode=ShadowCaster;False;False;0;;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;556;-342.2618,-860.8546;Float;False;False;-1;2;UnityEditor.ShaderGraphLitGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;DepthOnly;0;3;DepthOnly;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Lit;True;3;True;12;all;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;False;False;True;False;False;False;False;0;False;;False;False;False;False;False;False;False;False;False;True;1;False;;False;False;True;1;LightMode=DepthOnly;False;False;0;;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;557;-342.2618,-860.8546;Float;False;False;-1;2;UnityEditor.ShaderGraphLitGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;Meta;0;4;Meta;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Lit;True;3;True;12;all;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;2;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;1;LightMode=Meta;False;False;0;;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;558;-342.2618,-860.8546;Float;False;False;-1;2;UnityEditor.ShaderGraphLitGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;Universal2D;0;5;Universal2D;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Lit;True;3;True;12;all;0;False;True;1;1;False;;0;False;;1;1;False;;0;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;;False;False;False;False;False;False;False;False;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;1;LightMode=Universal2D;False;False;0;;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;559;-342.2618,-860.8546;Float;False;False;-1;2;UnityEditor.ShaderGraphLitGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;DepthNormals;0;6;DepthNormals;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Lit;True;3;True;12;all;0;False;True;1;1;False;;0;False;;0;1;False;;0;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;1;False;;True;3;False;;False;True;1;LightMode=DepthNormals;False;False;0;;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;560;-342.2618,-860.8546;Float;False;False;-1;2;UnityEditor.ShaderGraphLitGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;GBuffer;0;7;GBuffer;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Lit;True;3;True;12;all;0;False;True;1;1;False;;0;False;;1;1;False;;0;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;1;LightMode=UniversalGBuffer;False;False;0;;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;561;-342.2618,-860.8546;Float;False;False;-1;2;UnityEditor.ShaderGraphLitGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;SceneSelectionPass;0;8;SceneSelectionPass;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Lit;True;3;True;12;all;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;2;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;1;LightMode=SceneSelectionPass;False;False;0;;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;562;-342.2618,-860.8546;Float;False;False;-1;2;UnityEditor.ShaderGraphLitGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;ScenePickingPass;0;9;ScenePickingPass;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Lit;True;3;True;12;all;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;1;LightMode=Picking;False;False;0;;0;0;Standard;0;False;0
...
ASEEND*/
//CHKSM=2C940731BE6ADC39AAE03DCF9C0B4E20CFA6DEE6